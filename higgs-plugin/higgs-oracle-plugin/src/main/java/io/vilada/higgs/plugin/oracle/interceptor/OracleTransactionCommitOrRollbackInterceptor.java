...
public class OracleTransactionCommitOrRollbackInterceptor extends AbstractTransactionCommitOrRollbackInterceptor {
    public OracleTransactionCommitOrRollbackInterceptor(InterceptorContext interceptorContext) {
