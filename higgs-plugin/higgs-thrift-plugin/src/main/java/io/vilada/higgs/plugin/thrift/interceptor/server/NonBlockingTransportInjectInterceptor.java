 ...
 * @author cyp
 */
public class NonBlockingTransportInjectInterceptor extends AbstractSpanAroundInterceptor {

    
    public NonBlockingTransportInjectInterceptor(InterceptorContext interceptorContext) {
