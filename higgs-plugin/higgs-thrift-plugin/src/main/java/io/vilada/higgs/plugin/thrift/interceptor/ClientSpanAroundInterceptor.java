...
public abstract class ClientSpanAroundInterceptor extends ThriftSpanAroundInterceptor {
    public ClientSpanAroundInterceptor(InterceptorContext interceptorContext) {
        super(interceptorContext);
    }

    protected String getComponentName() {
        return ComponentEnum.THRIFT_CLIENT.getComponent();
    }
