...
public class ProtocolReadMessageBeginInterceptor extends AbstractNonSpanAroundInterceptor{
    public ProtocolReadMessageBeginInterceptor(InterceptorContext interceptorContext) {
	...
	protected void doAfter(Object target, Object[] args, Object result, Throwable throwable) {
		...
		traceContext.putTraceData(ThriftConstants.THRIFT_RPC_METHOD_NAME, methodName);
        traceContext.putTraceData(ThriftConstants.THRIFT_MSG_BEGIN_TIME, System.currentTimeMillis());
	}
