...
public class AsyncFunctionInterceptor extends AbstractNonSpanAroundInterceptor {
    private String methodName;
    public AsyncFunctionInterceptor(InterceptorContext interceptorContext) {
    ...
    protected void doBefore(Object target, Object[] args) {
        ...
        traceContext.putTraceData(ThriftConstants.THRIFT_ASYNC_FUNC_CALLED, builder.toString());
    }
