 ...
 * @author ethan
 */
public class MySQLPreparedStatementBindVariableInterceptor extends AbstractPreparedStatementBindVariableInterceptor {

    public MySQLPreparedStatementBindVariableInterceptor(InterceptorContext interceptorContext) {
    ...
    protected boolean isPluginEnable(ProfilerConfig profilerConfig) {
        return profilerConfig.readBoolean("higgs.jdbc.mysql.enable", true)
                && profilerConfig.readBoolean("higgs.jdbc.mysql.tracesqlbindvalue", true);
    }
}
