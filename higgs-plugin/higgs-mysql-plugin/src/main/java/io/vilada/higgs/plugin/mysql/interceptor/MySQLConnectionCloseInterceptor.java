 ...
 * @author ethan
 */
public class MySQLConnectionCloseInterceptor extends AbstractConnectionCloseInterceptor {

    public MySQLConnectionCloseInterceptor(InterceptorContext interceptorContext) {
