...
package io.vilada.higgs.agent.common.resolver;

import io.vilada.higgs.agent.common.resolver.condition.ClassResourceCondition;
import io.vilada.higgs.agent.common.resolver.condition.MainClassCondition;
import io.vilada.higgs.agent.common.resolver.condition.PropertyCondition;
...
public class ConditionProviderTest {
    ...
    private static final SimpleProperty PROPERTY_FOR_TEST = new SimpleProperty() {
        ...
        private final Map<String, String> properties = new HashMap<String, String>() {{
            put(JVMSystemPropertyKey.SUN_JAVA_COMMAND.getKey(), TEST_MAIN_CLASS);
