 ...
 * @author ethan
 */
public abstract class AbstractNonSpanAroundInterceptor extends AbstractAroundInterceptor {

    public AbstractNonSpanAroundInterceptor(InterceptorContext interceptorContext) {
    ...
    protected abstract void doBefore(Object target, Object[] args);

    protected void methodAfter(HiggsSpan higgsSpan, Object target,
                               Object[] args, Object result, Throwable throwable) {
        doAfter(target, args, result, throwable);
    }

    protected abstract void doAfter(Object target, Object[] args, Object result, Throwable throwable);
