...
public class DefaultSpanAroundInterceptor extends AbstractSpanAroundInterceptor {
    private final String componentName;
    private final String enableKey;
    public DefaultSpanAroundInterceptor(InterceptorContext interceptorContext, String componentName, String enableKey) {
    ...
    protected boolean isPluginEnable(ProfilerConfig profilerConfig) {
        return profilerConfig.readBoolean(enableKey, true);
    }
}
