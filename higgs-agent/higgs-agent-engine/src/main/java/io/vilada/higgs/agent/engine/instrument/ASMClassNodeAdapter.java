...
public class ASMClassNodeAdapter {
    ...
    public String getName() {
        return this.classNode.name == null ? null : JavaBytecodeUtil.jvmNameToJavaName(this.classNode.name);
    }
    ...
    public String getSuperClassName() {
        return this.classNode.superName == null ? null : JavaBytecodeUtil.jvmNameToJavaName(this.classNode.superName);
    }
    ...
    public String[] getInterfaceNames() {
        ...
        for (String name : interfaces) {
            if (name != null) {
                list.add(JavaBytecodeUtil.jvmNameToJavaName(name));
            }
        }
    ...
    public void addGetterMethod(final String methodName, final ASMFieldNodeAdapter fieldNode) {
        Type type = Type.getType(fieldNode.getDesc());
        addGetterMethod(methodName, fieldNode, type);
    }

    public void addGetterMethod(final String methodName, final ASMFieldNodeAdapter fieldNode, Type returnType) {
        if (methodName == null || fieldNode == null) {
            throw new IllegalArgumentException("method name or fieldNode annotation must not be null.");
        }

        // no argument is ().
        final String desc = "()" + returnType.getDescriptor();
    ...
    public void addInterface(final String interfaceName) {
        ...
        this.classNode.interfaces.add(JavaBytecodeUtil.javaNameToJvmName(interfaceName));
    }
