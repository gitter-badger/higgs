...
public final class ASMClassWriter extends ClassWriter {
    ...
    protected String getCommonSuperClass(String type1ClassInternalName, String type2ClassInternalName) {
        if (log.isDebugEnabled()) {
            log.debug("Getting common super class. type1ClassInternalName={}, type2ClassInternalName={}", type1ClassInternalName, type2ClassInternalName);
        }

        final String classInternalName = get(type1ClassInternalName, type2ClassInternalName);

        if (log.isDebugEnabled()) {
            log.debug("Common super class is '{}'. type1ClassInternalName={}, type2ClassInternalName={}", classInternalName, type1ClassInternalName, type2ClassInternalName);
        }
    ...
    private String get(final String type1ClassInternalName, final String type2ClassInternalName) {
        ...
        if (type1ClassReader == null || type2ClassReader == null) {
            log.warn("Skip get common super class. not found class {type1ClassInternalName={}, reader={}}, {type2ClassInternalName={}, reader={}}", type1ClassInternalName, type1ClassReader, type2ClassInternalName, type2ClassReader);
            return OBJECT_CLASS_INTERNAL_NAME;
        }
