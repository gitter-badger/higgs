...
public class AgentDirGenerator {
    ...
    private static final String bootStrapJar = "pinpoint-bootstrap-1.0.0-SNAPSHOT.jar";

    private static final String commons = "pinpoint-commons-1.0.0-SNAPSHOT.jar";
    private static final String bootStrapCoreJar = "pinpoint-bootstrap-core-1.0.0-SNAPSHOT.jar";
    private static final String bootStrapCoreOptionalJar = "pinpoint-bootstrap-core-optional-1.0.0-SNAPSHOT.jar";
    private static final String annotations = "pinpoint-annotations-1.0.0-SNAPSHOT.jar";
