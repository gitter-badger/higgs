...
public class MySQLStatementCreateInterceptor extends AbstractNonSpanAroundInterceptor {
    ...
    public MySQLStatementCreateInterceptor(InterceptorContext interceptorContext) {
    ...
    protected void doAfter(Object target, Object[] args, Object result, Throwable throwable) {
        ...
        if (target instanceof DatabaseURLAccessor
            ...
            DatabaseURLAccessor databaseURLAccessor = (DatabaseURLAccessor)connectionArg;
            String databaseUrl = databaseURLAccessor._$HIGGS$_getDatabaseUrl();
            if (databaseUrl != null) {
