 ...
 * @author mjolnir
 */
public class MySQLStatementExecuteInterceptor extends AbstractStatementExecuteInterceptor {

    public MySQLStatementExecuteInterceptor(InterceptorContext interceptorContext) {
