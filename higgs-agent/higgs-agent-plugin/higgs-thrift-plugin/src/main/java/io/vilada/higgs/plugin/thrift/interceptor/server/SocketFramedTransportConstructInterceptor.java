 ...
 * @author cyp
 */
public class SocketFramedTransportConstructInterceptor extends AbstractSpanAroundInterceptor {

    
    public SocketFramedTransportConstructInterceptor(InterceptorContext interceptorContext) {
