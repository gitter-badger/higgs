 ...
 * @author cyp
 */
public class SocketFastFramedTransportConstructInterceptor extends AbstractSpanAroundInterceptor {

    
    public SocketFastFramedTransportConstructInterceptor(InterceptorContext interceptorContext) {
