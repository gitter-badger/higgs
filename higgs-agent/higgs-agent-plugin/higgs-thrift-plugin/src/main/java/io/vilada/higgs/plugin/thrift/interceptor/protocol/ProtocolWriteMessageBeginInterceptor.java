...
public class ProtocolWriteMessageBeginInterceptor extends AbstractNonSpanAroundInterceptor {
    public ProtocolWriteMessageBeginInterceptor(InterceptorContext interceptorContext) {
