 ...
 * @author cyp
 */
public class AsyncProcessorInterceptor extends AbstractActiveSpanAroundInterceptor {
	private static HiggsAgentLogger LOGGER = HiggsAgentLoggerFactory.getLogger(
			AsyncProcessorInterceptor.class);
	private String methodName;

	public AsyncProcessorInterceptor(InterceptorContext interceptorContext) {
