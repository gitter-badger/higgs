...
public class SyncReceiveBaseInterceptor extends ClientSpanAroundInterceptor {
    public SyncReceiveBaseInterceptor(InterceptorContext interceptorContext) {
        super(interceptorContext);
    }

    @Override
    protected void doBefore(HiggsSpan higgsSpan, Object target, Object[] args) {
        traceContext.getAndRemoveTraceData(ThriftConstants.THRIFT_RPC_METHOD_NAME);
    }
}
