...
public class OraclePreparedStatementBindVariableInterceptor extends AbstractPreparedStatementBindVariableInterceptor {
    ...
    public OraclePreparedStatementBindVariableInterceptor(InterceptorContext interceptorContext) {
    ...
    protected boolean isPluginEnable(ProfilerConfig profilerConfig) {
        return profilerConfig.readBoolean("higgs.jdbc.oracle.enable", true) &&
                profilerConfig.readBoolean("higgs.jdbc.oracle.tracesqlbindvalue", true);
    }
}
