...
import io.vilada.higgs.agent.common.plugin.jdbc.interceptor.AbstractStatementExecuteInterceptor;
import io.vilada.higgs.common.trace.ComponentEnum;

/**
 * @author mjolnir
 */
public class OracleStatementExecuteInterceptor extends AbstractStatementExecuteInterceptor {

    public OracleStatementExecuteInterceptor(InterceptorContext interceptorContext) {
