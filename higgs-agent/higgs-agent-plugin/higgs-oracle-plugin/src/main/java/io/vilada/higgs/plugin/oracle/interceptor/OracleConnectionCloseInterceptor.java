...
import io.vilada.higgs.agent.common.plugin.jdbc.interceptor.AbstractConnectionCloseInterceptor;

/**
 * @author mjolnir
 */
public class OracleConnectionCloseInterceptor extends AbstractConnectionCloseInterceptor {

    public OracleConnectionCloseInterceptor(InterceptorContext interceptorContext) {
