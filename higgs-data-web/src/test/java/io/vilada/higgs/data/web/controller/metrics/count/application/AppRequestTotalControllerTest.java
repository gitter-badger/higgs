...
public class AppRequestTotalControllerTest {
    ...
    public void requestTotalTest() throws Exception {
        mvc.perform(
                MockMvcRequestBuilders.post("/server/metric/count/app/request-total").contentType(MediaType.APPLICATION_JSON)
                        .content("{\n" +
                                "    \"condition\": {\n" +
                ...
                //.andExpect(jsonPath("$.data.requestTotal").value(21939));
    ...
    public void testNullAppId() throws Exception {
        MockHttpServletRequestBuilder requestBuilder =
                MockMvcRequestBuilders.post("/server/metric/count/app/request-total")
