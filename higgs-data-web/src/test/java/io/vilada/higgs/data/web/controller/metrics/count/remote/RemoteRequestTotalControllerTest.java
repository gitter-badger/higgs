...
public class RemoteRequestTotalControllerTest {

	@Autowired
	private MockMvc mvc;
	
	@Test
	public void testNormalRequestTotal() throws Exception {

		mvc.perform(MockMvcRequestBuilders.post("/server/metric/count/remote/request-total")
	...
	@Test
	public void testNullRequestTotal() throws Exception {
