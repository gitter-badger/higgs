...
public class DatabaseListControllerTest {
    ...
    @Test
    public void databaseListTest() throws Exception {
        mvc.perform(
                MockMvcRequestBuilders.post("/server/metric/meta/database-list").contentType(MediaType.APPLICATION_JSON)
                        .content("{\n" +
                                "    \"condition\": {\n" +
    ...
    public void testNullAppId() throws Exception {
        MockHttpServletRequestBuilder requestBuilder =
                MockMvcRequestBuilders.post("/server/metric/meta/database-list")
