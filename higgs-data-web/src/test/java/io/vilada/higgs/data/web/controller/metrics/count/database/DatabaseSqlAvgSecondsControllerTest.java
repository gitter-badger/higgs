...
package io.vilada.higgs.data.web.controller.metrics.count.database;
...
/**
 * 
 * @author wangtao1 2018-03-09 15:58
 *
 */
@RunWith(SpringJUnit4ClassRunner.class)
@SpringBootTest(classes = DataWebSiteApplication.class)
@AutoConfigureMockMvc
public class DatabaseSqlAvgSecondsControllerTest {

	@Autowired
	private MockMvc mvc;

	@Test
	public void testNormalSqlAvgSeconds() throws Exception {

		mvc.perform(MockMvcRequestBuilders.post("/server/metric/count/database/sql-avg-seconds")
	...
	@Test
	public void testNullSqlAvgSeconds() throws Exception {
		mvc.perform(MockMvcRequestBuilders.post("/server/metric/count/database/sql-avg-seconds")
				.contentType(MediaType.APPLICATION_JSON_UTF8)
				.content("{\n" + 
						"    \"condition\": {\n" + 
