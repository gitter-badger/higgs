...
public class DatabaseRpmControllerTest {

	@Autowired
	private MockMvc mvc;

	@Test
	public void testNormalRpm() throws Exception {

		mvc.perform(MockMvcRequestBuilders.post("/server/metric/count/database/rpm")
	...
	@Test
	public void testNullRpm() throws Exception {
		mvc.perform(MockMvcRequestBuilders.post("/server/metric/count/database/rpm")
				.contentType(MediaType.APPLICATION_JSON_UTF8)
				.content("{\n" + 
						"    \"condition\": {\n" + 
