...
/**
 * Created by leigengxin on 2018-3-11.
 */

@RunWith(SpringJUnit4ClassRunner.class)
@SpringBootTest(classes=DataWebSiteApplication.class)
@AutoConfigureMockMvc
public class AppRequestTotalHistogramControllerTest {
    ...
    public void requestTotalTest() throws Exception {
        mvc.perform(
                MockMvcRequestBuilders.post("/server/metric/histogram/app/request-total").contentType(MediaType.APPLICATION_JSON)
                        .content("{\n" +
                                "    \"condition\": {\n" +
    ...
    public void testNullAppId() throws Exception {
        MockHttpServletRequestBuilder requestBuilder =
                MockMvcRequestBuilders.post("/server/metric/histogram/app/request-total")
