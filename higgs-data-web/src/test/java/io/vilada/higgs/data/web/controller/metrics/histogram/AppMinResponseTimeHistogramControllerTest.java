...
public class AppMinResponseTimeHistogramControllerTest {
    ...
    @Test
    public void responseMinSecondsTest() throws Exception {
        mvc.perform(
                MockMvcRequestBuilders.post("/server/metric/histogram/app/response-min-seconds").contentType(MediaType.APPLICATION_JSON)
                        .content("{\n" +
                                "    \"condition\": {\n" +
    ...
    public void testNullAppId() throws Exception {
        MockHttpServletRequestBuilder requestBuilder =
                MockMvcRequestBuilders.post("/server/metric/histogram/app/response-min-seconds")
