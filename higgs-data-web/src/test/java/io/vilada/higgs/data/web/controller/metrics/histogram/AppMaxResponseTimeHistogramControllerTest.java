...
public class AppMaxResponseTimeHistogramControllerTest {
    ...
    @Test
    public void responseMaxSecondsTest() throws Exception {
        mvc.perform(
                MockMvcRequestBuilders.post("/server/metric/histogram/app/response-max-seconds").contentType(MediaType.APPLICATION_JSON)
                        .content("{\n" +
                                "    \"condition\": {\n" +
    ...
    public void testNullAppId() throws Exception {
        MockHttpServletRequestBuilder requestBuilder =
                MockMvcRequestBuilders.post("/server/metric/histogram/app/response-max-seconds")
