...
public class AppInstanceHealthControllerTest {
    ...
    public void testNormalRequest() throws Exception {
        mvc.perform(
                MockMvcRequestBuilders.post("/server/metric/count/tier/health").contentType(MediaType.APPLICATION_JSON)
                        .content("{\n" +
                                "    \"condition\": {\n" +
    ...
    public void testNullAppId() throws Exception {
        MockHttpServletRequestBuilder requestBuilder =
                MockMvcRequestBuilders.post("/server/metric/count/tier/health")
