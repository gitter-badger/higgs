...
public class AppResponseAvgSecondsControllerTest {
    ...
    public void responseAvgSecondsTest() throws Exception {
        mvc.perform(
                MockMvcRequestBuilders.post("/server/metric/count/app/response-avg-seconds").contentType(MediaType.APPLICATION_JSON)
                        .content("{\n" +
                                "    \"condition\": {\n" +
                ...
                //.andExpect(jsonPath("$.data.avgResponseTime").value(530.3758730460398));
    ...
    public void testNullAppId() throws Exception {
        MockHttpServletRequestBuilder requestBuilder =
                MockMvcRequestBuilders.post("/server/metric/count/app/response-avg-seconds")
