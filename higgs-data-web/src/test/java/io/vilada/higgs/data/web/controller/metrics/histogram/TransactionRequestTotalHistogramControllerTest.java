...
/**
 * Created by wsong on 2018-3-13.
 */

@RunWith(SpringJUnit4ClassRunner.class)
@SpringBootTest(classes=DataWebSiteApplication.class)
@AutoConfigureMockMvc
public class TransactionRequestTotalHistogramControllerTest {
    ...
    public void testNormalRequest() throws Exception {
        mvc.perform(
                MockMvcRequestBuilders.post("/server/metric/histogram/transaction/request-total").contentType(MediaType.APPLICATION_JSON)
                        .content("{\n" +
                                "    \"condition\": {\n" +
                                "        \"appId\": \"722905091556839424\",\n" +
                                "        \"startTime\": 1519833600000,\n" +
                                "        \"endTime\": 1520352000000,\n" +
    ...
    public void testNullAppId() throws Exception {
        MockHttpServletRequestBuilder requestBuilder =
                MockMvcRequestBuilders.post("/server/metric/histogram/transaction/request-total")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("{\n" +
                                "    \"condition\": {\n" +
                                "        \"startTime\": 1519315372353,\n" +
                                "        \"endTime\": 1519661972000,\n" +
                                "        \"aggrInterval\": 3600000,\n" +
                                "        \"transName\": \"/user.do\"\n" +
                                "    }\n" +
                                "}  ");
    ...
    @Test
    public void testNullTransactionName() throws Exception {
        MockHttpServletRequestBuilder requestBuilder =
                MockMvcRequestBuilders.post("/server/metric/histogram/transaction/request-total")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("{\n" +
