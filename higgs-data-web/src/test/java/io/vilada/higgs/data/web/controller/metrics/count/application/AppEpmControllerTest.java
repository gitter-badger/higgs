...
public class AppEpmControllerTest {
    ...
    public void epmTest() throws Exception {
        mvc.perform(
                MockMvcRequestBuilders.post("/server/metric/count/app/epm").contentType(MediaType.APPLICATION_JSON)
                        .content("{\n" +
                                "    \"condition\": {\n" +
    ...
    public void testNullAppId() throws Exception {
        MockHttpServletRequestBuilder requestBuilder =
                MockMvcRequestBuilders.post("/server/metric/count/app/epm")
