...
public class AppApdexControllerTest {
    ...
    public void apdexTest() throws Exception {
        mvc.perform(
                MockMvcRequestBuilders.post("/server/metric/count/app/apdex").contentType(MediaType.APPLICATION_JSON)
                        .content("{\n" +
                                "    \"condition\": {\n" +
    ...
    public void testNullAppId() throws Exception {
        MockHttpServletRequestBuilder requestBuilder =
                MockMvcRequestBuilders.post("/server/metric/count/app/apdex")
    ...
    @Test
    public void getHealthStateNormal() throws Exception {
        mvc.perform(
                MockMvcRequestBuilders.post("/server/metric/count/app/health").contentType(MediaType.APPLICATION_JSON)
                        .content("{\n" +
                                "    \"condition\": {\n" +
