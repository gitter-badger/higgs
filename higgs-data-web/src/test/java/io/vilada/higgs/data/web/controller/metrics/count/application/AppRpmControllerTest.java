...
public class AppRpmControllerTest {
    ...
    public void rpmTest() throws Exception {
        mvc.perform(
                MockMvcRequestBuilders.post("/server/metric/count/app/rpm").contentType(MediaType.APPLICATION_JSON)
                        .content("{\n" +
                                "    \"condition\": {\n" +
                ...
                //.andExpect(jsonPath("$.data.rpm").value(3.81));
    ...
    public void testNullAppId() throws Exception {
        MockHttpServletRequestBuilder requestBuilder =
                MockMvcRequestBuilders.post("/server/metric/count/app/rpm")
