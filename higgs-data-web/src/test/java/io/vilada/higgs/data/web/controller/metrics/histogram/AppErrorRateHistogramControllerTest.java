...
public class AppErrorRateHistogramControllerTest {
    ...
    @Test
    public void errorRatioTest() throws Exception {
        mvc.perform(
                MockMvcRequestBuilders.post("/server/metric/histogram/app/error-ratio").contentType(MediaType.APPLICATION_JSON)
                        .content("{\n" +
                                "    \"condition\": {\n" +
    ...
    public void testNullAppId() throws Exception {
        MockHttpServletRequestBuilder requestBuilder =
                MockMvcRequestBuilders.post("/server/metric/histogram/app/error-ratio")
