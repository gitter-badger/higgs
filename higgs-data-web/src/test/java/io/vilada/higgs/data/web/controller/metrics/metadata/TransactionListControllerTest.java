...
public class TransactionListControllerTest {
    ...
    @Test
    public void transactionListTest() throws Exception {
        mvc.perform(
                MockMvcRequestBuilders.post("/server/metric/meta/transaction-list").contentType(MediaType.APPLICATION_JSON)
                        .content("{\n" +
                                "    \"condition\": {\n" +
                ...
                //.andExpect(jsonPath("$.data.transactionList").value(Arrays.asList("/",
                        //"/common.do", "/order.do", "/user.do", "/goods.do")));
    ...
    public void testNullAppId() throws Exception {
        MockHttpServletRequestBuilder requestBuilder =
                MockMvcRequestBuilders.post("/server/metric/meta/transaction-list")
