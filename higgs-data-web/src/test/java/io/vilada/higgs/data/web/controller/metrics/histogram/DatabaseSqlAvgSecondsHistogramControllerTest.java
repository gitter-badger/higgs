...
public class DatabaseSqlAvgSecondsHistogramControllerTest {
    ...
    public void testNormalRequest() throws Exception {
        mvc.perform(
                MockMvcRequestBuilders.post("/server/metric/histogram/database/sql-avg-seconds").contentType(MediaType.APPLICATION_JSON)
                        .content("{\n" +
                                "    \"condition\": {\n" +
    ...
    public void testNullAppId() throws Exception {
        MockHttpServletRequestBuilder requestBuilder =
                MockMvcRequestBuilders.post("/server/metric/histogram/database/sql-avg-seconds")
