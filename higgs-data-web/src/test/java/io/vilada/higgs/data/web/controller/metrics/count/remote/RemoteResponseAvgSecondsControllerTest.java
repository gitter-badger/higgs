...
public class RemoteResponseAvgSecondsControllerTest {

	@Autowired
	private MockMvc mvc;
	
	@Test
	public void testNormalResponseAvgSeconds() throws Exception {

		mvc.perform(MockMvcRequestBuilders.post("/server/metric/count/remote/response-avg-seconds")
	...
	@Test
	public void testNullResponseAvgSeconds() throws Exception {
