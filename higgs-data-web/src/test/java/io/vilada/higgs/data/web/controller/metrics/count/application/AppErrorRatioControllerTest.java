...
public class AppErrorRatioControllerTest {
    ...
    public void errorRatioTest() throws Exception {
        mvc.perform(
                MockMvcRequestBuilders.post("/server/metric/count/app/error-ratio").contentType(MediaType.APPLICATION_JSON)
                        .content("{\n" +
                                "    \"condition\": {\n" +
                ...
                //.andExpect(jsonPath("$.data.errorRate").value(0.12));
    ...
    public void testNullAppId() throws Exception {
        MockHttpServletRequestBuilder requestBuilder =
                MockMvcRequestBuilders.post("/server/metric/count/app/error-ratio")
