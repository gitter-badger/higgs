...
public class PageOrderUtils {
    ...
    public static Pageable getPageable(Page page, io.vilada.higgs.data.web.service.bo.in.v2.Sort order) {
        if(order == null){
    ...
    public static Sort getSort(io.vilada.higgs.data.web.service.bo.in.v2.Sort order) {
        Sort sort;
