...
public final class DefaultJsonDeserializerFactory implements DeserializerFactory<TDeserializer> {
    ...
    public static final DefaultJsonDeserializerFactory INSTANCE = new DefaultJsonDeserializerFactory();

    private static TProtocolFactory protocolFactory = new TJSONProtocol.Factory();
